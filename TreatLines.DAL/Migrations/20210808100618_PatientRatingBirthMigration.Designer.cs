...
namespace TreatLines.DAL.Migrations
{
    ...
    [Migration("20210808100618_PatientRatingBirthMigration")]
    partial class PatientRatingBirthMigration
    {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "5d74b82b-4f16-492d-aceb-b31193630eab",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "71abfaf0-04ca-4cd5-b29f-ee853ead8232",
                            Name = "HospitalAdmin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "97dcfce5-0ba5-4743-9a0c-0e21caa032b4",
                            Name = "Doctor",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "f04f0970-a79b-45a7-aaa5-91bd3564adfa",
                            Name = "Patient",
            ...
            modelBuilder.Entity("TreatLines.DAL.Entities.Doctor", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = "E8D13331-62AB-463E-A283-6493B68A3622",
                            DateOfBirth = new DateTimeOffset(new DateTime(1970, 10, 13, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 0, 0, 0)),
            ...
            modelBuilder.Entity("TreatLines.DAL.Entities.Patient", b =>
                {
                    ...
                    b.Property<double>("HospitalRating")
                        .HasColumnType("float");
                    ...
                    b.HasData(
                        new
                        {
                            UserId = "E3A6BF34-A57D-4709-97CC-6AD1B2B3985B",
                            BloodType = "O-",
                            DateOfBirth = new DateTimeOffset(new DateTime(1990, 1, 6, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 2, 0, 0, 0)),
                            Discount = 5.0,
                            HospitalId = 1,
                            HospitalRating = 0.0,
                            Sex = "Male"
            ...
            modelBuilder.Entity("TreatLines.DAL.Entities.Schedule", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            EndTime = new DateTimeOffset(new DateTime(2021, 8, 8, 18, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 0, 0, 0)),
                            StartTime = new DateTimeOffset(new DateTime(2021, 8, 8, 8, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 0, 0, 0)),
                            WorkDays = "01234"
                        });
                });
            ...
            modelBuilder.Entity("TreatLines.DAL.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Blocked = false,
                            ConcurrencyStamp = "c2cb4c54-3786-42d3-b34a-1f4e2ee72baf",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEARI4pJ8S5FLHJUh+frJHJRF1JW8QbGo6EDCCzFaWzkZAsrEs6TU+WEy+qMsqSLusA==",
                            PhoneNumber = "+38(050)245-32-52",
                            PhoneNumberConfirmed = false,
                            RegistrationDate = new DateTimeOffset(new DateTime(2021, 7, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 0, 0, 0)),
                            SecurityStamp = "2b6abf80-6b79-48a1-aa08-4d049b262b19",
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Blocked = false,
                            ConcurrencyStamp = "1ea719e1-9205-40cc-9271-7a3e620f6e75",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEFabvEpNBVNxyk8tom/5oc22a5z+STmZsilhs65DDLwOtgKJ7yRQIrXnKWOxpBcaJg==",
                            PhoneNumber = "+38(096)498-65-82",
                            PhoneNumberConfirmed = false,
                            RegistrationDate = new DateTimeOffset(new DateTime(2021, 7, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 0, 0, 0)),
                            SecurityStamp = "4cdb4ced-71e6-4b5c-947d-45a138c43c71",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Blocked = false,
                            ConcurrencyStamp = "9afd200e-873d-43a4-9527-5b2d036bd687",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEHp9/z0/zfObMgpEVAtT0UKs/n+6wCSG5yvgVt1ebPFVv6PPxFfMbREytCgMD2lI+Q==",
                            PhoneNumber = "+38(096)336-65-27",
                            PhoneNumberConfirmed = false,
                            RegistrationDate = new DateTimeOffset(new DateTime(2021, 7, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 0, 0, 0)),
                            SecurityStamp = "d5caf907-040b-4f46-ab40-8cc2e65c93c0",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            Blocked = false,
                            ConcurrencyStamp = "33f84c1c-54fa-4f15-8dcc-93004bf23baa",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAELps5bMLE7DDKoOjsiP2aDCUXSwZOFc/QmlqmHA+V2NgtrJWC2OaCVfdya8lEi4I3A==",
                            PhoneNumber = "+38(096)838-36-82",
                            PhoneNumberConfirmed = false,
                            RegistrationDate = new DateTimeOffset(new DateTime(2021, 7, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 3, 0, 0, 0)),
                            SecurityStamp = "6ca9d7da-f29a-4ede-8303-cc43a9433f6c",
                            TwoFactorEnabled = false,
